  ...
  return (
    <div className=' w-full text-white flex '>
      ...
      <div className={`flex justify-center  ${label ? ("w-[90%]"):"w-full"}`}>
        <input {...props} onChange={onChange}  type={type} placeholder={placeholder} name={name} className={`sm:w-[90%] w-[380px]  p-2 bg-white text-black font-semibold rounded-lg ${className}`}  {...register(name, { required } ,{onChange: (e) => console.log(e.target.value)})} />
