  ...
  return (
    <div className="relative">
      ...
      <div className="w-full flex flex-wrap gap-4 pt-3 ">
        {/* likes and all */}
        <div className="flex  cursor-pointer py-2 items-center text-white text-xl px-4 rounded-full  bg-gray-800 gap-2 w-min">
          <div onClick={toggleLike}>
            <AiFillLike />
          </div>{" "}
          <div className="font-semibold text-sm ">{likes.length}</div>
        </div>
        <div
          onClick={handleDownload}
          className="text-sm py-2 cursor-pointer text-white flex gap-2 items-center font-semibold px-4 rounded-full bg-gray-800"
        >
          Download
        </div>
        <div
      ...
      <div
        ...
        } z-30  w-full h-full absolute top-0`}
      >
            ...
            <ul className="mb-4">
              ...
              {userPlaylistList.map((playlist, index) => (
                <li
                  ...
                  className="mx-2 my-1 font-semibold bg-gray-900 text-white border-[1px] rounded-lg p-4 text-lg"
                  key={index}
                >
                  {playlist.name}
                </li>
